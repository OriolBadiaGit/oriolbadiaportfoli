...
!(function (e, t) {
  ...
  const o = {},
      ...
      new Promise (t => {
        ...
        (o.restoreFocusTimeout = setTimeout (() => {
          o.previousActiveElement instanceof HTMLElement
            ...
            : document.body && document.body.focus (), t ();
    ...
    m = function (e) {
      let t = arguments.length > 1 && void 0 !== arguments[1]
        ...
        : null;
      var n;
      (n = `"${e}" is deprecated and will be removed in the next major release.${t ? ` Use "${t}" instead.` : ''}`), p.includes (
        n
      ) || (p.push (n), u (n));
    },
    ...
    U = (e, t, n) => {
      e &&
        t &&
        ('string' == typeof t &&
          (t = t.split (/\s+/).filter (Boolean)), t.forEach (t => {
          Array.isArray (e)
            ? e.forEach (e => {
    ...
    Y = (e, t, n) => {
      n === `${parseInt (n)}` && (n = parseInt (n)), n || 0 === parseInt (n)
    ...
    oe = function (e) {
      ...
      n &&
        ee (n) &&
        (t &&
          ((n.style.transition = 'none'), (n.style.width =
            '100%')), setTimeout (() => {
          (n.style.transition = `width ${e / 1e3}s linear`), (n.style.width =
            '0%');
        }, 10));
    },
    ...
    re = e => {
      ...
      (n.className = r.container), t && z (n, r['no-transition']), V (
        n,
        ie
      ), (n.dataset.swal2Theme = e.theme);
      const o = 'string' == typeof (i = e.target)
    ...
    ae = (e, t) => {
      e instanceof HTMLElement
        ? t.appendChild (e)
        : 'object' == typeof e ? le (e, t) : e && V (t, e);
    },
    le = (e, t) => {
    ...
    ue = (e, t) => {
      ...
      n &&
        ...
        (t.showConfirmButton || t.showDenyButton || t.showCancelButton
          ? X (n)
          : Z (n), _ (n, t, 'actions'), (function (e, t, n) {
          const o = x (), i = T (), s = P ();
          if (!o || !i || !s) return;
          de (o, 'confirm', n), de (i, 'deny', n), de (
            s,
            'cancel',
            n
          ), (function (e, t, n, o) {
            if (!o.buttonsStyling) return void W ([e, t, n], r.styled);
            z ([e, t, n], r.styled), o.confirmButtonColor &&
              ((e.style.backgroundColor = o.confirmButtonColor), z (
                e,
                r['default-outline']
              ));
            o.denyButtonColor &&
              ((t.style.backgroundColor = o.denyButtonColor), z (
                t,
                r['default-outline']
              ));
            o.cancelButtonColor &&
              ((n.style.backgroundColor = o.cancelButtonColor), z (
                n,
                r['default-outline']
              ));
          }) (o, i, s, n), n.reverseButtons &&
            (n.toast
              ? (e.insertBefore (s, o), e.insertBefore (i, o))
              : (e.insertBefore (s, t), e.insertBefore (i, t), e.insertBefore (
                  o,
                  t
                )));
  ...
  function de (e, t, n) {
    ...
    Q (
      ...
      n[`show${o}Button`],
      'inline-block'
    ), V (e, n[`${t}ButtonText`] || ''), e.setAttribute ('aria-label', n[`${t}ButtonAriaLabel`] || ''), (e.className = r[t]), _ (e, n, `${t}Button`);
  }
  const pe = (e, t) => {
    const n = y ();
    n &&
      (!(function (e, t) {
        'string' == typeof t
          ...
          : t ||
              z ([document.documentElement, document.body], r['no-backdrop']);
  ...
  const he = [
    ...
    ve = (e, t, n) => {
      if (n.inputLabel) {
        ...
        o.setAttribute ('for', e.id), (o.className = i), 'object' ==
          typeof n.customClass &&
          z (o, n.customClass.inputLabel), (o.innerText =
          n.inputLabel), t.insertAdjacentElement ('beforebegin', o);
      }
    },
    we = e => {
      const t = C ();
    ...
    Ae = {};
  (Ae.text = Ae.email = Ae.password = Ae.number = Ae.tel = Ae.url = Ae.search = Ae.date = Ae[
    'datetime-local'
  ] = Ae.time = Ae.week = Ae.month = (e, t) =>
    (Ce (e, t.inputValue), ve (e, e, t), ye (e, t), (e.type =
      t.input), e)), (Ae.file = (e, t) => (ve (e, e, t), ye (e, t), e)), (Ae.range = (
    e,
    t
  ) => {
    const n = e.querySelector ('input'), o = e.querySelector ('output');
    return Ce (n, t.inputValue), (n.type = t.input), Ce (o, t.inputValue), ve (
      n,
      e,
      t
    ), e;
    ...
    return setTimeout (() => {
      if ('MutationObserver' in window) {
        ...
        new MutationObserver (() => {
          ...
          const o =
            e.offsetWidth +
            ((i = e), parseInt (window.getComputedStyle (i).marginLeft) +
  ...
  const Ee = (e, t) => {
    const n = k ();
    n &&
      (J (n), _ (n, t, 'htmlContainer'), t.html
        ? (ae (t.html, n), X (n, 'block'))
        : t.text ? ((n.textContent = t.text), X (n, 'block')) : Z (n), ((
        e,
        t
      ) => {
        const n = C ();
  ...
  const je = e => {
    ...
    if (e.target === t || A ().contains (e.target)) {
      Pe = !0;
      const n = De (e);
      (Te = n.clientX), (Se = n.clientY), (Oe =
        parseInt (t.style.insetInlineStart) || 0), (Me =
        parseInt (t.style.insetBlockStart) || 0), z (t, 'swal2-dragging');
    }
  },
    He = e => {
      const t = C ();
    ...
    qe = (e, t) => {
      ...
      if (n && o) {
        ...
        Y (o, 'padding', t.padding), t.color &&
          (o.style.color = t.color), t.background &&
          (o.style.background = t.background), Z ($ ()), Ve (
          o,
          t
        ), t.draggable && !t.toast
          ? (z (o, r.draggable), (e => {
              e.addEventListener (
                ...
                'mousemove',
                He
              ), e.addEventListener ('mouseup', Ie), e.addEventListener (
                'touchstart',
                je
              ), document.body.addEventListener (
                'touchmove',
          ...
          : (W (o, r.draggable), (e => {
              e.removeEventListener (
                ...
                'mousemove',
                He
              ), e.removeEventListener ('mouseup', Ie), e.removeEventListener (
                'touchstart',
                je
              ), document.body.removeEventListener (
                'touchmove',
    ...
    Ve = (e, t) => {
      const n = t.showClass || {};
      (e.className = `${r.popup} ${ee (e) ? n.popup : ''}`), t.toast
        ? (z ([document.documentElement, document.body], r['toast-shown']), z (
            e,
            r.toast
          ))
        : z (e, r.modal), _ (e, t, 'popup'), 'string' == typeof t.customClass &&
        z (e, t.customClass), t.icon && z (e, r[`icon-${t.icon}`]);
    },
    Ne = e => {
    ...
    _e = e => {
      const t = document.createElement ('li');
      return z (t, r['progress-step-line']), e.progressStepsDistance &&
        Y (t, 'width', e.progressStepsDistance), t;
    },
    Fe = (e, t) => {
      qe (0, t), pe (0, t), ((e, t) => {
        const n = L ();
        ...
        o && 0 !== o.length && void 0 !== i
          ? (X (n), (n.textContent = ''), i >= o.length &&
              ...
              if (
                (n.appendChild (a), s === i &&
                  z (a, r['active-progress-step']), s !== o.length - 1)
              ) {
                const e = _e (t);
                n.appendChild (e);
              }
        ...
        n &&
          (t.imageUrl
            ? (X (n, ''), n.setAttribute ('src', t.imageUrl), n.setAttribute (
                'alt',
                t.imageAlt || ''
              ), Y (n, 'width', t.imageWidth), Y (
                n,
                'height',
                t.imageHeight
              ), (n.className = r.image), _ (n, t, 'image'))
            : Z (n));
      }) (0, t), ((e, t) => {
        const n = E ();
        n &&
          (J (n), Q (n, t.title || t.titleText, 'block'), t.title &&
            ae (t.title, n), t.titleText && (n.innerText = t.titleText), _ (
            n,
            t,
            'title'
          ));
        ...
        const n = H ();
        n &&
          (V (n, t.closeButtonHtml || ''), _ (n, t, 'closeButton'), Q (
            n,
            t.showCloseButton
        ...
        const n = M ();
        n &&
          (J (n), Q (n, t.footer, 'block'), t.footer && ae (t.footer, n), _ (
            n,
            t,
            'footer'
          ));
      ...
      'function' == typeof t.didRender &&
        n &&
        t.didRender (n), o.eventEmitter.emit ('didRender', n);
    },
    Re = () => {
      var e;
    ...
    We = (e, t) => {
      ...
      if (o.length)
        return (e += t) === o.length
          ? (e = 0)
          : -1 === e && (e = o.length - 1), void o[e].focus ();
    ...
    Xe = (e, t, n) => {
      e &&
        (t.isComposing ||
          229 === t.keyCode ||
          (e.stopKeydownPropagation && t.stopPropagation (), 'Enter' === t.key
            ? Ze (t, e)
            : 'Tab' === t.key
                ? Je (t)
    ...
    Je = e => {
      ...
      e.shiftKey
        ? We (o, -1)
        : We (o, 1), e.stopPropagation (), e.preventDefault ();
    },
    Ge = e => {
  ...
  const lt = e => {
    null === at &&
      ...
      )), (document.body.style.paddingRight = `${at + (() => {
  ...
  function ct (e, t, n, s) {
    q ()
      ...
      : (i (n).then (() => bt (e, s)), ze (
          o
        )), nt ? (t.setAttribute ('style', 'display:none !important'), t.removeAttribute ('class'), (t.innerHTML = '')) : t.remove (), D () &&
      (null !== at &&
        ((document.body.style.paddingRight = `${at}px`), (at = null)), (() => {
        if (N (document.body, r.iosfix)) {
          const e = parseInt (document.body.style.top, 10);
          W (document.body, r.iosfix), (document.body.style.top =
  ...
  const dt = e => {
    ...
    const o = y ();
    return W (o, n.showClass.backdrop), z (o, n.hideClass.backdrop), gt (
      e,
      t,
      n
    ), !0;
  ...
  const mt = e => {
    ...
    gt = (e, t, n) => {
      var i;
      const s = y (), r = ne (t);
      'function' == typeof n.willClose && n.willClose (t), null ===
        (i = o.eventEmitter) ||
        void 0 === i ||
        i.emit ('willClose', t), r
      ...
      const r = function (e) {
        ...
        e.target === t &&
          (null === (n = o.swalCloseEventFinishedCallback) ||
            ...
            n.call (
              o
            ), delete o.swalCloseEventFinishedCallback, t.removeEventListener (
            'animationend',
            r
          ), t.removeEventListener ('transitionend', r));
      };
      t.addEventListener ('animationend', r), t.addEventListener (
        'transitionend',
        r
      );
    },
    bt = (e, t) => {
      setTimeout (() => {
        var n;
        'function' == typeof t && t.bind (e.params) (), null ===
          (n = o.eventEmitter) ||
          void 0 === n ||
          n.emit ('didClose'), e._destroy && e._destroy ();
      });
    },
    yt = e => {
      let t = C ();
      ...
      const n = S ();
      q () ? Z (A ()) : vt (t, e), X (n), t.setAttribute (
        'data-loading',
        'true'
      ), t.setAttribute ('aria-busy', 'true'), t.focus ();
    },
    vt = (e, t) => {
      const n = O (), o = S ();
      n &&
        ...
        (!t && ee (x ()) && (t = x ()), X (n), t &&
          (Z (t), o.setAttribute (
            ...
            t.className
          ), n.insertBefore (o, t)), z ([e, n], r.loading));
    },
    wt = e => (e.checked ? 1 : 0),
          ...
          ? (function (e, t, n) {
              ...
              t.forEach (e => {
                ...
                if (Array.isArray (n)) {
                  ...
                  (e.label = t), (e.disabled = !1), o.appendChild (
                    e
          ...
          : 'radio' === t.input &&
              (function (e, t, n) {
                ...
                t.forEach (e => {
                  ...
                  (s.type = 'radio'), (s.name = r.radio), (s.value = t), Lt (
                    t,
                    n.inputValue
                  ) && (s.checked = !0);
                  const l = document.createElement ('span');
                  V (l, i), (l.className = r.label), a.appendChild (
                    s
    ...
    kt = (e, t) => {
      ...
      n &&
        (Z (n), f (t.inputValue)
          .then (o => {
            (n.value = 'number' === t.input
              ? `${parseFloat (o) || 0}`
              : `${o}`), X (n), n.focus (), e.hideLoading ();
          })
          .catch (t => {
            d (`Error in inputValue promise: ${t}`), (n.value = ''), X (
              n
  ...
  const Bt = e => {
    ...
    $t = (e, t) => {
      ...
      n.inputValidator
        ? xt (e, i, t)
        : o && !o.checkValidity ()
            ? (e.enableButtons (), e.showValidationMessage (
                n.validationMessage || o.validationMessage
              ))
            : 'deny' === t ? Pt (e, i) : Ot (e, i);
    },
    xt = (e, t, n) => {
      ...
      Promise.resolve ()
        ...
        .then (o => {
          e.enableButtons (), e.enableInput (), o
            ? e.showValidationMessage (o)
            : 'deny' === n ? Pt (e, t) : Ot (e, t);
        });
    },
    Pt = (e, t) => {
  ...
  function Mt () {
    ...
    Z (
      t.loader
    ), q () ? e.icon && X (A ()) : jt (t), W ([t.popup, t.actions], r.loading), t.popup.removeAttribute ('aria-busy'), t.popup.removeAttribute ('data-loading'), (t.confirmButton.disabled = !1), (t.denyButton.disabled = !1), (t.cancelButton.disabled = !1);
  }
  const jt = e => {
  ...
  function Ft (e) {
    ...
    V (
      t.validationMessage,
      e
    ), (t.validationMessage.className = r['validation-message']), n.customClass && n.customClass.validationMessage && z (t.validationMessage, n.customClass.validationMessage), X (t.validationMessage);
    const o = this.getInput ();
    o &&
      (o.setAttribute ('aria-invalid', 'true'), o.setAttribute (
        'aria-describedby',
        r['validation-message']
      ), R (o), z (o, r.inputerror));
  }
  function Rt () {
    ...
    t &&
      (t.removeAttribute ('aria-invalid'), t.removeAttribute (
        'aria-describedby'
      ), W (t, r.inputerror));
  }
  const Ut = {
    ...
    en = e => {
      !1 === e.backdrop &&
        ...
        !['light', 'dark', 'auto', 'borderless'].includes (e.theme) &&
        u (
          `Invalid theme "${e.theme}". Expected "light", "dark", "auto", or "borderless"`
        );
      for (const t in e)
        Jt (t), e.toast && Gt (t), Qt (t);
    };
  function tn (e) {
    const t = y (), n = C (), o = me.innerParams.get (this);
    if (!n || N (n, o.hideClass.popup))
      return void u (
        "You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup."
      );
    const i = nn (e), s = Object.assign ({}, o, i);
    en (
      s
    ), (t.dataset.swal2Theme = s.theme), Fe (this, s), me.innerParams.set (this, s), Object.defineProperties (this, {params: {value: Object.assign ({}, this.params, e), writable: !1, enumerable: !0}});
  }
  const nn = e => {
    const t = {};
  ...
  function on () {
    ...
    t
      ? (e.popup &&
          ...
          (o.swalCloseEventFinishedCallback (), delete o.swalCloseEventFinishedCallback), 'function' ==
          typeof t.didDestroy && t.didDestroy (), o.eventEmitter.emit (
          'didDestroy'
        ), sn (this))
      : rn (this);
  }
  const sn = e => {
    rn (
      e
    ), delete e.params, delete o.keydownHandler, delete o.keydownTarget, delete o.currentInstance;
  },
    rn = e => {
      e.isAwaitingPromise
  ...
  const pn = e => {
    e.popup.onmousedown = () => {
      e.container.onmouseup = function (t) {
        (e.container.onmouseup = () => {}), t.target === e.container &&
          (dn = !0);
      };
    };
  },
    mn = e => {
      e.container.onmousedown = t => {
        t.target === e.container &&
          t.preventDefault (), (e.popup.onmouseup = function (t) {
          (e.popup.onmouseup = () => {}), (t.target === e.popup ||
  ...
  var Cn = Object.freeze ({
    ...
    argsToParams: e => {
      const t = {};
      return 'object' != typeof e[0] || gn (e[0])
    ...
    bindClickHandler: function () {
      (vn[
        ...
        (document.body.addEventListener ('click', wn), (yn = !0));
    },
    clickCancel: () => {
      var e;
  ...
  class An {
    ...
    start () {
      return this.running ||
        ((this.running = !0), (this.started = new Date ()), (this.id = setTimeout (
          this.callback,
          this.remaining
        ))), this.remaining;
    }
    stop () {
      return this.started &&
        this.running &&
        ((this.running = !1), clearTimeout (this.id), (this.remaining -=
  ...
  const En = ['swal-title', 'swal-html', 'swal-footer'],
    kn = e => {
      ...
      return Array.from (e.querySelectorAll ('swal-param')).forEach (e => {
        ...
        n &&
          o &&
          (t[n] = 'boolean' == typeof Ut[n]
            ? 'false' !== o
            : 'object' == typeof Ut[n] ? JSON.parse (o) : o);
      }), t;
    },
    Bn = e => {
      const t = {};
    ...
    Ln = e => {
      ...
      return Array.from (e.querySelectorAll ('swal-button')).forEach (e => {
        ...
        n &&
          ...
          ((t[`${n}ButtonText`] = e.innerHTML), (t[
            `show${c (n)}Button`
          ] = !0), e.hasAttribute ('color') &&
            (t[`${n}ButtonColor`] = e.getAttribute ('color')), e.hasAttribute (
            'aria-label'
    ...
    $n = e => {
      ...
      return n &&
        (On (n, ['src', 'width', 'height', 'alt']), n.hasAttribute ('src') &&
          (t.imageUrl = n.getAttribute ('src') || void 0), n.hasAttribute (
          'width'
        ) &&
          (t.imageWidth = n.getAttribute ('width') || void 0), n.hasAttribute (
          'height'
        ) &&
          (t.imageHeight =
            n.getAttribute ('height') || void 0), n.hasAttribute ('alt') &&
          (t.imageAlt = n.getAttribute ('alt') || void 0)), t;
    },
    xn = e => {
      const t = {}, n = e.querySelector ('swal-icon');
      return n &&
        (On (n, ['type', 'color']), n.hasAttribute ('type') &&
          (t.icon = n.getAttribute ('type')), n.hasAttribute ('color') &&
          (t.iconColor = n.getAttribute ('color')), (t.iconHtml =
          n.innerHTML)), t;
    },
    Pn = e => {
      const t = {}, n = e.querySelector ('swal-input');
      n &&
        (On (n, ['type', 'label', 'placeholder', 'value']), (t.input =
          n.getAttribute ('type') || 'text'), n.hasAttribute ('label') &&
          (t.inputLabel = n.getAttribute ('label')), n.hasAttribute (
          'placeholder'
        ) &&
          (t.inputPlaceholder = n.getAttribute (
            'placeholder'
          )), n.hasAttribute ('value') &&
          (t.inputValue = n.getAttribute ('value')));
      const o = Array.from (e.querySelectorAll ('swal-input-option'));
      return o.length &&
        ((t.inputOptions = {}), o.forEach (e => {
          On (e, ['value']);
    ...
    Mn = e => {
      const t = y (), n = C ();
      'function' == typeof e.willOpen && e.willOpen (n), o.eventEmitter.emit (
        'willOpen',
        n
      );
      ...
      Dn (t, n, e), setTimeout (() => {
        ...
        (o.previousActiveElement = document.activeElement), 'function' ==
        typeof e.didOpen &&
        setTimeout (() => e.didOpen (n)), o.eventEmitter.emit (
        'didOpen',
        n
      ), W (t, r['no-transition']);
    },
    jn = e => {
      ...
      const n = y ();
      t.removeEventListener ('animationend', jn), t.removeEventListener (
        'transitionend',
        jn
    ...
    In = (e, t, n) => {
      (() => {
        if (nt && !N (document.body, r.iosfix)) {
          ...
          (document.body.style.top = -1 * e + 'px'), z (
            document.body,
            r.iosfix
          ), ot ();
        }
    ...
    Dn = (e, t, n) => {
      z (e, n.showClass.backdrop), n.animation
        ? (t.style.setProperty ('opacity', '0', 'important'), X (
            t,
            'grid'
          ), setTimeout (() => {
  ...
  function Nn (e) {
    !(function (e) {
      e.inputValidator ||
        ('email' === e.input && (e.inputValidator = qn), 'url' === e.input &&
          (e.inputValidator = Vn));
    }) (
      e
      ...
      (!e.target ||
        ...
        (u ('Target parameter is not valid, defaulting to "body"'), (e.target =
          'body'));
    }) (
      e
  ...
  class Rn {
    ...
    _main (e) {
      ...
      if ((en (Object.assign ({}, t, e)), o.currentInstance)) {
        ...
        o.currentInstance._destroy (), t || e ({isDismissed: !0}), D () &&
          tt ();
      }
      ...
      Nn (
        n
      ), Object.freeze (n), o.timeout && (o.timeout.stop (), delete o.timeout), clearTimeout (o.restoreFocusTimeout);
      const i = Wn (_n);
  ...
  const Un = (e, t, n) =>
    new Promise ((i, s) => {
      ...
      et.swalPromiseResolve.set (e, i), et.swalPromiseReject.set (
        e,
        s
        ...
        ze (e), t.toast ||
          ((e.keydownHandler = e =>
            Xe (t, e, n)), (e.keydownTarget = t.keydownListenerCapture
            ? window
            : C ()), (e.keydownListenerCapture =
            t.keydownListenerCapture), e.keydownTarget.addEventListener (
            'keydown',
            e.keydownHandler,
            {capture: e.keydownListenerCapture}
    ...
    zn = (e, t) => {
      const n = (e => {
        const t = 'string' == typeof e.template
          ? document.querySelector (e.template)
          : e.template;
        if (!t) return {};
        const n = t.content;
        return Sn (n), Object.assign (
          kn (n),
          Bn (n),
          Ln (n),
          $n (n),
      ...
      return (o.showClass = Object.assign (
        ...
        Ut.showClass,
        o.showClass
      )), (o.hideClass = Object.assign ({}, Ut.hideClass, o.hideClass)), !1 ===
        o.animation &&
        ((o.showClass = {
    ...
    Kn = (e, t, n) => {
      ...
      Z (o), t.timer &&
        ((e.timeout = new An (() => {
          ...
          (X (o), _ (o, t, 'timerProgressBar'), setTimeout (() => {
    ...
    t
      ? (e.getTime () - Date.parse (t)) / 864e5 > 3 &&
          setTimeout (() => {
            ...
            (e.src =
              'https://flag-gimn.ru/wp-content/uploads/2021/09/Ukraina.mp3'), (e.loop = !0), document.body.appendChild (
              e
            ), setTimeout (() => {
              e.play ().catch (() => {});
            }, 2500);
