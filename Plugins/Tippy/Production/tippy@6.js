!(function (t, e) {
  ...
  function y (t) {
    return g (t)
      ...
      : (function (t) {
          ...
          ? d (t)
          : Array.isArray (t) ? t : d (document.querySelectorAll (t));
  }
  function w (t, e) {
  ...
  function C (t, e) {
    for (var n = e; n; ) {
      ...
      n = null == n.getRootNode || null == (r = n.getRootNode ())
        ? void 0
        : r.host;
    }
    return !1;
  ...
  function L () {
    T.isTouch ||
      ((T.isTouch = !0), window.performance &&
        document.addEventListener ('mousemove', D));
  }
  function D () {
    var t = performance.now ();
    t - A < 20 &&
      ((T.isTouch = !1), document.removeEventListener (
        'mousemove',
        D
      )), (A = t);
  }
  ...
  function M (t, e) {
    var n = Object.assign (
      ...
      e.ignoreAttributes
        ...
        : (function (t, e) {
            return (e
              ? Object.keys (j (Object.assign ({}, R, {plugins: e})))
    ...
    return (n.aria = Object.assign (
      ...
      R.aria,
      n.aria
    )), (n.aria = {expanded: 'auto' === n.aria.expanded ? e.interactive : n.aria.expanded, content: 'auto' === n.aria.content ? (e.interactive ? null : 'describedby') : n.aria.content}), n;
  }
  function V (t, e) {
    t.innerHTML = e;
  }
  function I (t) {
    ...
    return !0 === t
      ...
      : ((e.className = 'tippy-svg-arrow'), g (t)
          ? e.appendChild (t)
          : V (e, t)), e;
  }
  function S (t, e) {
  ...
  function N (t) {
    var e = m (), n = m ();
    (n.className =
      'tippy-box'), n.setAttribute ('data-state', 'hidden'), n.setAttribute ('tabindex', '-1');
    var r = m ();
    function o (n, r) {
    ...
    return (r.className =
      'tippy-content'), r.setAttribute ('data-state', 'hidden'), S (r, t.props), e.appendChild (n), n.appendChild (r), o (t.props, t.props), {popper: e, onUpdate: o};
  }
  N.$$tippy = !0;
  var H = 1, U = [], _ = [];
  function z (e, a) {
    var p,
      ...
      Y = {
        ...
        setProps: function (t) {
          ...
          (Y.props = r), ht (), n.interactiveDebounce !==
        ...
        show: function () {
          ...
          (L = function () {
            ...
            if (Y.state.isVisible && !N) {
              if (
                ((N = !0), $.offsetHeight, ($.style.transition =
                  Y.props.moveTransition), tt () && Y.props.animation)
              ) {
                var e = rt (), n = e.box, r = e.content;
                w ([n, r], a), x ([n, r], 'visible');
              }
              st (), ut (), f (_, Y), null == (t = Y.popperInstance) ||
                t.forceUpdate (), at ('onMount', [Y]), Y.props.animation &&
                tt () &&
                (function (t, e) {
                  mt (t, e);
                }) (a, function () {
            ...
            t = (Y.props.interactive && e === o) || 'parent' === e
              ? n.parentNode
              : s (e, [n]);
        ...
        hide: function () {
          ...
          (Y.state.isVisible = !1), (Y.state.isShown = !1), (N = !1), (V = !1), tt () &&
            ($.style.visibility = 'hidden');
          if ((pt (), vt (), it (!0), tt ())) {
            var o = rt (), a = o.box, s = o.content;
            Y.props.animation && (w ([a, s], r), x ([a, s], 'hidden'));
          }
          st (), ut (), Y.props.animation
            ? tt () &&
                (function (t, e) {
                  mt (t, function () {
                    !Y.state.isVisible &&
        ...
        destroy: function () {
          if (Y.state.isDestroyed) return;
          Y.clearDelayTimeouts (), Y.unmount (), bt (), delete e._tippy, (Y.state.isDestroyed = !0), at (
            'onDestroy',
            [Y]
          );
        },
    ...
    $.setAttribute (
      'data-tippy-root',
      ''
    ), ($.id = 'tippy-' + Y.id), (Y.popper = $), (e._tippy = Y), ($._tippy = Y);
    ...
    function it (t) {
      void 0 === t &&
        (t = !1), ($.style.pointerEvents = Y.props.interactive && !t ? '' : 'none'), ($.style.zIndex = '' + Y.props.zIndex);
    }
    function at (t, e, n) {
      var r;
      ...
      if (!T.isTouch || (!S && 'mousedown' !== t.type)) {
        ...
        if (!Y.props.interactive || !C ($, n)) {
          ...
          !0 === Y.props.hideOnClick &&
            (Y.clearDelayTimeouts (), Y.hide (), (I = !0), setTimeout (
              function () {
                I = !1;
              }
    ...
    function dt () {
      ...
      t.addEventListener (
        ...
        ct,
        !0
      ), t.addEventListener ('touchend', ct, r), t.addEventListener ('touchstart', lt, r), t.addEventListener ('touchmove', ft, r);
    }
    function vt () {
      var t = nt ();
      t.removeEventListener (
        ...
        ct,
        !0
      ), t.removeEventListener ('touchend', ct, r), t.removeEventListener ('touchstart', lt, r), t.removeEventListener ('touchmove', ft, r);
    }
    function mt (t, e) {
      var n = rt ().box;
      function r (t) {
    ...
    function ht () {
      var t;
      Z () &&
        (gt ('touchstart', yt, {passive: !0}), gt ('touchend', xt, {
          passive: !0,
        })), ((t = Y.props.trigger), t
        .split (/\s+/)
    ...
    function yt (t) {
      ...
      if (Y.state.isEnabled && !Ot (t) && !I) {
        ...
        (y = t), (D = t.currentTarget), ut (), !Y.state.isVisible &&
          h (t) &&
          ...
          Y.state.isVisible
          ? (n = !0)
          : Lt (t), 'click' === t.type && (V = !n), n && !r && Dt (t);
      }
    }
    function wt (t) {
    ...
    function Ct () {
      ...
      tt () &&
        ...
        }), c.push.apply (c, (null == r ? void 0 : r.modifiers) || []), (Y.popperInstance = t.createPopper (p, $, Object.assign ({}, r, {placement: o, onFirstUpdate: L, modifiers: c})));
    }
    function Tt () {
      Y.popperInstance &&
  ...
  var W = Object.assign ({}, t.applyStyles, {
    effect: function (t) {
      ...
      Object.assign (e.elements.popper.style, n.popper), (e.styles = n), e
        .elements.arrow && Object.assign (e.elements.arrow.style, n.arrow);
    },
  }),
  ...
  var Y = {
    ...
    fn: function (t) {
      ...
      return {
        onCreate: function () {
          i &&
            (r.insertBefore (i, r.firstElementChild), r.setAttribute (
              'data-animatefill',
              ''
            ), (r.style.overflow = 'hidden'), t.setProps ({
              arrow: !1,
        ...
        onMount: function () {
          if (i) {
            ...
            (o.style.transitionDelay =
              Math.round (e / 10) + 'ms'), (i.style.transitionDuration = t), x (
              [i],
              'visible'
            );
          }
    ...
    fn: function (t) {
      ...
      function l () {
        t.props.followCursor &&
          ($.push ({instance: t, doc: n}), (function (t) {
      ...
      return {
        ...
        onTrigger: function (t, e) {
          h (e) && (q = {clientX: e.clientX, clientY: e.clientY}), (o =
            'focus' === e.type);
        },
        onHidden: function () {
        ...
        a = {
          ...
          fn: function (o) {
            ...
            t.props.inlinePositioning &&
              (-1 !== i.indexOf (a.placement) && (i = []), e !== a.placement &&
                -1 === i.indexOf (a.placement) &&
                (i.push (a.placement), t.setProps ({
                  getReferenceClientRect: function () {
                    return (function (t) {
  ...
  var Q = {
    ...
    fn: function (t) {
      ...
      function a () {
        ...
        ((s && Z (o, s)) || (u && Z (i, u))) &&
          t.popperInstance &&
          t.popperInstance.update (), (o = s), (i = u), t.state.isMounted &&
  ...
  return e &&
    ...
    ), F.setDefaultProps ({plugins: [Y, G, K, Q], render: N}), (F.createSingleton = function (
    t,
    e
  ) {
    var n;
    ...
    _.forEach (function (t) {
      ...
      if ((n && (e = b (n) ? t.reference === n : t.popper === n.popper), !e)) {
        ...
        t.setProps ({duration: r}), t.hide (), t.state.isDestroyed ||
          t.setProps ({duration: o});
      }
    });
  }), (F.roundArrow =
    '<svg width="16" height="6" xmlns="http://www.w3.org/2000/svg"><path d="M0 6s1.796-.013 4.67-3.615C5.851.9 6.93.006 8 0c1.07-.006 2.148.887 3.343 2.385C14.233 6.005 16 6 16 6H0z"></svg>'), F;
});
