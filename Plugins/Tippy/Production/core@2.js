...
!(function (e, t) {
  ...
  function p (e, o, i) {
    ...
    o &&
      r (e) &&
      ((f = (e.offsetWidth > 0 && s (a.width) / e.offsetWidth) || 1), (p =
  ...
  function d (e) {
    return ((n (e) ? e.ownerDocument : e.document) ||
  ...
  function g (e) {
    ...
    return Math.abs (t.width - n) <= 1 &&
      (n =
        t.width), Math.abs (t.height - r) <= 1 && (r = t.height), {x: e.offsetLeft, y: e.offsetTop, width: n, height: r};
  }
  function b (e) {
    return 'html' === l (e)
      ? e
      ...
      : n (r)
          ? (function (e, t) {
              ...
              return (n.top = n.top + e.clientTop), (n.left =
                ...
                n.left + e.clientWidth), (n.width = e.clientWidth), (n.height =
                e.clientHeight), (n.x = n.left), (n.y = n.top), n;
            }) (r, o)
          : N (
              (function (e) {
                var t,
    ...
    var f = 'clippingParents' === t
      ...
      u = c.reduce (function (t, n) {
        ...
        return (t.top = i (
          r.top,
          t.top
        )), (t.right = a (r.right, t.right)), (t.bottom = a (r.bottom, t.bottom)), (t.left = i (r.left, t.left)), t;
      }, I (e, p, s));
    return (u.width =
      u.right -
      u.left), (u.height = u.bottom - u.top), (u.x = u.left), (u.y = u.top), u;
  }
  function F (e) {
    return e.split ('-')[0];
  }
        ...
        u = {
          ...
          setOptions: function (r) {
            ...
            l (), (f.options = Object.assign (
              ...
              reference: n (e)
                ? w (e)
                : e.contextElement ? w (e.contextElement) : [],
              popper: w (t),
            });
            var s,
              p,
            ...
            if (!p) {
              ...
              if (Q (t, n)) {
                (f.rects = {
                  ...
                  popper: g (n),
                }), (f.reset = !1), (f.placement =
                  f.options.placement), f.orderedModifiers.forEach (function (
                  e
                ) {
  ...
  function re (e) {
    ...
    if (u) {
      ...
      if (
        (W === t (r) &&
          ...
          'absolute' === c &&
          ((H = 'scrollHeight'), (T = 'scrollWidth')), (W = W), i === D ||
          ((i === P || i === L) && a === B))
      )
        (M = A), (b -=
    ...
    var R,
      ...
      V = !0 === l
        ...
        : {x: y, y: b};
    return (y =
      V.x), (b = V.y), p ? Object.assign ({}, S, (((R = {})[M] = O ? '0' : ''), (R[j] = w ? '0' : ''), (R.transform = (k.devicePixelRatio || 1) <= 1 ? 'translate(' + y + 'px, ' + b + 'px)' : 'translate3d(' + y + 'px, ' + b + 'px, 0)'), R)) : Object.assign ({}, S, (((n = {})[M] = O ? b + 'px' : ''), (n[j] = w ? y + 'px' : ''), (n.transform = ''), n));
  }
  var oe = {
    name: 'computeStyles',
    enabled: !0,
  ...
  var ie = {
    ...
    fn: function (e) {
      ...
      Object.keys (t.elements).forEach (function (e) {
        ...
        r (i) &&
          l (i) &&
          (Object.assign (i.style, n), Object.keys (o).forEach (function (e) {
            var t = o[e];
            !1 === t
              ? i.removeAttribute (e)
    ...
    effect: function (e) {
      ...
      return Object.assign (
        ...
        Object.keys (t.elements).forEach (function (e) {
          ...
          r (o) &&
            l (o) &&
            (Object.assign (o.style, a), Object.keys (i).forEach (function (e) {
              o.removeAttribute (e);
            }));
        });
      };
  ...
  var ae = {
    ...
    fn: function (e) {
      var t = e.state,
        ...
        c = s.y;
      null != t.modifiersData.popperOffsets &&
        ((t.modifiersData.popperOffsets.x += f), (t.modifiersData.popperOffsets.y += c)), (t.modifiersData[
        r
      ] = a);
    },
  },
    ...
    fn: function (e) {
      ...
      if (!t.modifiersData[r]._skip) {
        for (
          ...
          if (
            (i && N.push (V[H] <= 0), s &&
              N.push (V[q] <= 0, V[C] <= 0), N.every (function (e) {
              return e;
            }))
          ) {
            (E = B), (j = !1);
