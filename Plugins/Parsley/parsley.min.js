!(function (t, e) {
      ...
      attr: function (t, e, i) {
        ...
        for (r = (s = t.attributes).length; r--; )
          (n = s[r]) &&
            ...
            a.test (n.name) &&
            (i[
              this.camelize (n.name.slice (e.length))
  ...
  r.prototype = {
    ...
    _pipeAccordingToValidationResult: function () {
      function t () {
        var t = h.Deferred ();
        return !0 !== e.validationResult &&
          t.reject (), t.resolve ().promise ();
      }
      var e = this;
      return [t, t];
    },
    ...
    _resetOptions: function (t) {
      for (var e in ((this.domOptions = d.objectCreate (
        this.parent.options
      )), (this.options = d.objectCreate (this.domOptions)), t))
    ...
    validate: function (t, e) {
      if (this.fn)
        return 3 < arguments.length &&
          (e = [].slice.call (arguments, 1, -1)), this.fn (t, e);
      if (Array.isArray (t)) {
      ...
      if (this.validateDate && i._isDateInput ())
        return (arguments[0] = d.parse.date (arguments[0])), null !==
          arguments[0] && this.validateDate.apply (this, arguments);
      if (this.validateNumber)
        return (
          !t ||
          (!isNaN (t) &&
            ((arguments[0] = parseFloat (
              arguments[0]
      ...
      return h.isPlainObject (i)
        ? (function (t, e, i) {
            ...
            for (var s in t)
              if (s) {
                var a = i (s);
                'string' == typeof a && (a = d.parseRequirement (t[s], a)), (n[
                  s
                ] = a);
  ...
  function a (t, e) {
    (this.__class__ =
      'ValidatorRegistry'), (this.locale = 'en'), this.init (t || {}, e || {});
  }
  var p = {
  ...
  a.prototype = {
    init: function (t, e) {
      for (var i in ((this.catalog = e), (this.validators = l (
        {},
        this.validators
      )), t))
    ...
    addCatalog: function (t, e, i) {
      return 'object' === n (e) && (this.catalog[t] = e), !0 === i
        ? this.setLocale (t)
        : this;
    },
    addMessage: function (t, e, i) {
      return void 0 === this.catalog[t] &&
        (this.catalog[t] = {}), (this.catalog[t][e] = i), this;
    },
    ...
    updateValidator: function (t, e, i) {
      return this.validators[t]
        ...
        : (d.warn (
            'Validator "' + t + '" is not already defined.'
          ), this.addValidator.apply (this, arguments));
    },
    removeValidator: function (t) {
      return this.validators[t] ||
        d.warn ('Validator "' + t + '" is not defined.'), delete this
        .validators[t], this;
    },
    _setValidator: function (t, e, i) {
      for (var r in ('object' !== n (e) &&
        (e = {fn: e, priority: i}), e.validate ||
        (e = new c (e)), (this.validators[t] = e).messages || {}))
  ...
  (v.Form = {
    ...
    _reflowUI: function () {
      if ((this._buildUI (), this._ui)) {
        ...
        (this._ui.lastValidationResult = this.validationResult), this._manageStatusClass (), this._manageErrorsMessages (
          t
        ), this._actualizeTriggers (), (!t.kept.length && !t.added.length) ||
          this._failedOnce ||
    ...
    addError: function (t, e) {
      var i = 1 < arguments.length && void 0 !== e ? e : {},
        ...
        s = i.updateClass,
        a = void 0 === s || s;
      this._buildUI (), this._addError (t, {message: r, assert: n}), a &&
        this._errorClass ();
    },
    updateError: function (t, e) {
      var i = 1 < arguments.length && void 0 !== e ? e : {},
        ...
        s = i.updateClass,
        a = void 0 === s || s;
      this._buildUI (), this._updateError (t, {message: r, assert: n}), a &&
        this._errorClass ();
    },
    ...
    _addError: function (t, e) {
      ...
      this._insertErrorWrapper (), this._ui.$errorClassHandler.attr (
        'aria-describedby',
        this._ui.errorsWrapperId
      ), this._ui.$errorsWrapper
        .addClass ('filled')
      ...
      if (!this._ui && !1 !== this.options.uiEnabled) {
        ...
        this.element.setAttribute (
          ...
          (this.options.multiple
            ...
            : this.__id__)), (t.$errorsWrapper = h (
          this.options.errorsWrapper
        ).attr (
          'id',
          t.errorsWrapperId
    ...
    _manageClassHandler: function () {
      ...
      if (
        ('string' == typeof this.options.classHandler &&
          ...
          (t = window[this.options.classHandler]), 'function' == typeof t)
      ) {
    ...
    _insertErrorWrapper: function () {
      ...
      return 'function' == typeof t && (t = t.call (this, this)), 'object' ===
        n (t) && t.length
    ...
    _actualizeTriggers: function () {
      ...
      i.off ('.Parsley'), this._failedOnce
        ? i.on (
    ...
    _resetUI: function () {
      (this._failedOnce = !1), this._actualizeTriggers (), void 0 !==
        this._ui &&
        (this._ui.$errorsWrapper
          .removeClass ('filled')
          .children ()
          .remove (), this._resetClass (), (this._ui.lastValidationResult = []), (this._ui.validationInformationVisible = !1));
    },
    _destroyUI: function () {
      this._resetUI (), void 0 !== this._ui &&
        this._ui.$errorsWrapper.remove (), delete this._ui;
    },
    _successClass: function () {
      (this._ui.validationInformationVisible = !0), this._ui.$errorClassHandler
  ...
  function y (t, e, i) {
    (this.__class__ =
      'Form'), (this.element = t), (this.$element = h (t)), (this.domOptions = e), (this.options = i), (this.parent = window.Parsley), (this.fields = []), (this.validationResult = null);
  }
  ...
  y.prototype = {
    onSubmitValidate: function (t) {
      ...
      if (!0 !== t.parsley) {
        ...
        if (
          ((this._submitSource = null), this.$element
            .find ('.parsley-synthetic-submit-button')
            .prop ('disabled', !0), !i ||
            null === i.getAttribute ('formnovalidate'))
        ) {
          window.Parsley._remoteCache = {};
          var r = this.whenValidate ({event: t});
          ('resolved' === r.state () && !1 !== this._trigger ('submit')) ||
            (t.stopImmediatePropagation (), t.preventDefault (), 'pending' ===
              r.state () &&
              r.done (function () {
                e._submit (i);
              }));
    ...
    whenValidate: function (t) {
      ...
      (this.submitEvent = a) &&
        ...
        })), (this.validationResult = !0), this._trigger (
        'validate'
      ), this._refreshFields ();
  ...
  function w (t, e, i, r) {
    (this.__class__ =
      'Field'), (this.element = t), (this.$element = h (t)), void 0 !== r && (this.parent = r), (this.options = i), (this.domOptions = e), (this.constraints = []), (this.constraintsByName = {}), (this.validationResult = !0), this._bindConstraints ();
  }
  var F = {
    pending: null,
    resolved: !0,
  ...
  w.prototype = {
    ...
    whenValidate: function (t) {
      ...
      if ((this.refresh (), !s || this._isInGroup (s)))
        return (this.value = this.getValue ()), this._trigger (
          'validate'
    ...
    needsValidation: function (t) {
      return void 0 === t && (t = this.getValue ()), !(!t.length &&
        !this._isRequired () &&
    ...
    whenValid: function (t) {
      ...
      if ((e._refreshed || this.refresh (), !a || this._isInGroup (a))) {
        if (((this.validationResult = !0), !this.hasConstraints ()))
          return h.when ();
        if (
          (null == s && (s = this.getValue ()), !this.needsValidation (s) &&
            !0 !== n)
        )
          return h.when ();
    ...
    _validateConstraint: function (t, e) {
      ...
      return !1 === r && (r = h.Deferred ().reject ()), d
        .all ([r])
        .fail (function (t) {
          i.validationResult instanceof Array ||
            (i.validationResult = []), i.validationResult.push ({assert: e, errorMessage: 'string' == typeof t && t});
        });
    },
    getValue: function () {
      var t;
      return null ==
        (t = 'function' == typeof this.options.value
    ...
    destroy: function () {
      this._destroyUI (), this.$element.removeData (
        'Parsley'
      ), this.$element.removeData ('FieldMultiple'), this._trigger ('destroy');
    },
    refresh: function () {
    ...
    addConstraint: function (t, e, i, r) {
      if (window.Parsley._validatorRegistry.validators[t]) {
        ...
        'undefined' !== this.constraintsByName[n.name] &&
          this.removeConstraint (n.name), this.constraints.push (
          n
    ...
    _bindConstraints: function () {
      for (var t = [], e = {}, i = 0; i < this.constraints.length; i++)
        !1 === this.constraints[i].isDomConstraint &&
          (t.push (this.constraints[i]), (e[
            this.constraints[i].name
          ] = this.constraints[i]));
      for (var r in ((this.constraints = t), (this.constraintsByName = e), this
        .options))
    ...
    _bindHtml5Constraints: function () {
      null !== this.element.getAttribute ('required') &&
        this.addConstraint ('required', !0, void 0, !0), null !==
      ...
      null !== t && null !== e
        ...
        : null !== t
            ...
            : null !== e && this.addConstraint ('max', e, void 0, !0), null !==
  ...
  function A (t, e, i) {
    ...
    if (r)
      return void 0 !== i &&
        ...
        ((r.parent = i), r._resetOptions (r.options)), 'object' === n (e) &&
        l (r.options, e), r;
  ...
  A.prototype = {
    init: function (t) {
      return (this.__class__ = 'Parsley'), (this.__version__ =
        '2.9.2'), (this.__id__ = d.generateID ()), this._resetOptions (
        t
    ...
    handleMultiple: function () {
      ...
      if (
        ((this.options.multiple =
          ...
          this.element.getAttribute ('id')), 'SELECT' ===
          this.element.nodeName &&
          null !== this.element.getAttribute ('multiple'))
      )
        return (this.options.multiple =
          this.options.multiple || this.__id__), this.bind (
      ...
      return this.bind ('parsleyField', !0), e ||
  ...
  l (
    ...
    v.Field,
    r.prototype
  ), l (y.prototype, v.Form, r.prototype), l (A.prototype, r.prototype), (h.fn.parsley = h.fn.psly = function (
    t
  ) {
    if (1 < this.length) {
      var e = [];
  ...
  }), void 0 === window.ParsleyExtend && (window.ParsleyExtend = {}), (x.options = l (d.objectCreate (s), window.ParsleyConfig)), (window.ParsleyConfig = x.options), (window.Parsley = window.psly = x), (x.Utils = d), (window.ParsleyUtils = {}), h.each (
    d,
    function (t, e) {
      'function' == typeof e &&
  ...
  (window.ParsleyValidator = {}), h.each (
  ...
  return (h.listen = function (t, e) {
    var i;
    if (
      (V (), 'object' === n (arguments[1]) &&
        'function' == typeof arguments[2] &&
        ((i = arguments[1]), (e = arguments[2])), 'function' != typeof e)
    )
    ...
    validateString: function (t, e, i, r) {
      ...
      (n = h.extend (!0, {}, {url: e, data: a, type: 'GET'}, l)), r.trigger (
        'field:ajaxoptions',
        r,
        n
      ), (s = h.param (n)), void 0 === x._remoteCache && (x._remoteCache = {});
      function u () {
